...
def preload_env(kbc_path, dataset, graph_type, mode="hard", kg_path=None,
                explain=False,extra_datasets=None,switch=False):
    ...
    try:
        ...
        for name,parameter in kbc.model.named_parameters():
        ...
        if QuerDAG.TYPE1_1.value == graph_type:
            if switch == False:
                ...
                raw_data=list(extra_datasets[1][('e', ('r',))])
                torch.save(raw_data,'/data/cqd2/type1_1ind.pt')
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
                    new_ex.data["raw_chain"]=[ex[0],ex[1][0],targets]
                    new_ex.data["anchors"]=[ex[0]]
                    new_ex.data["type"]="1chain1"
                    new_ex.data["targets"]=targets
                    raw.append(new_ex)
            ...
            if switch == False:
                ...
                raw_data=list(extra_datasets[1][('e', ('r', 'r'))])
                torch.save(raw_data,'/data/cqd2/type1_2ind.pt')
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
                    new_ex.data["raw_chain"]=[[ex[0],ex[1][0],-1],[-1,ex[1][1],targets]]
                    new_ex.data["anchors"]=[ex[0]]
                    new_ex.data["type"]="1chain2"
                    new_ex.data["targets"]=targets
                    raw.append(new_ex)
            type1_2chain = []
            for i in range(len(raw)):
            ...
            if switch == False:
                ...
                raw_data=list(extra_datasets[1][(('e', ('r',)), ('e', ('r',)))])
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
                    new_ex.data["raw_chain"]=[[ex[0][0],ex[0][1][0],targets],[ex[1][0],ex[1][1][0],targets]]
                    new_ex.data["anchors"]=[ex[0][0],ex[1][0]]
                    new_ex.data["type"]="2chain2_not"
                    new_ex.data["targets"]=targets
                    raw.append(new_ex)
            ...
            chains = [chain1,chain2]
            parts = [part1,part2]
        elif QuerDAG.TYPE2_2_not.value == graph_type:
            raw_data=list(extra_datasets[1][(('e', ('r',)), ('e', ('r', 'n')))])
            raw=[]
            for ex in raw_data:
                new_ex=Chain()
                targets=list(extra_datasets[0][ex])
            ...
            if switch == False:
                ...
                raw_data=list(extra_datasets[1][(('e', ('r',)), ('e', ('r',)), ('u',))])
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
            ...
            if switch == False:
                ...
                raw_data=list(extra_datasets[1][('e', ('r', 'r', 'r'))])
                torch.save(raw_data,'/data/cqd2/type1_3ind.pt')
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
                    new_ex.data["raw_chain"]=[[ex[0],ex[1][0],-1],[-1,ex[1][1],-2],[-2,ex[1][2],targets]]
                    new_ex.data["anchors"]=[ex[0]]
                    new_ex.data["type"]="1chain3"
                    new_ex.data["targets"]=targets
                    raw.append(new_ex)
            ...
            if switch == False:
                ...
                raw_data=list(extra_datasets[1][(('e', ('r',)), ('e', ('r',)), ('e', ('r',)))])
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
                    new_ex.data["raw_chain"]=[[ex[0][0],ex[0][1][0],targets],[ex[1][0],ex[1][1][0],targets],[ex[2][0],ex[2][1][0],targets]]
                    new_ex.data["anchors"]=[ex[0][0],ex[1][0],ex[2][0]]
                    new_ex.data["type"]="2chain3"
                    new_ex.data["targets"]=targets
                    raw.append(new_ex)
            ...
            chains = [chain1,chain2,chain3]
            parts = [part1,part2,part3]
        elif QuerDAG.TYPE2_3_not.value == graph_type:
            if switch == False:
                raw = dataset.type2_3chain
            else:
                raw_data=list(extra_datasets[1][(('e', ('r',)), ('e', ('r',)), ('e', ('r','n')))])
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
            ...
            if switch == False:
                ...
                raw_data=list(extra_datasets[1][(('e', ('r', 'r')), ('e', ('r',)))])
                torch.save(raw_data,'/data/cqd2/type3_3ind.pt')
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
                    new_ex.data["raw_chain"]=[[ex[0][0],ex[0][1][0],-1],[-1,ex[0][1][1],targets],[ex[1][0],ex[1][1][0],targets]]
                    new_ex.data["anchors"]=[ex[0][0],ex[1][0]]
                    new_ex.data["type"]="3chain3"
                    new_ex.data["targets"]=targets
                    raw.append(new_ex)
            ...
            chains = [chain1,chain2,chain3]
            parts = [part1, part2, part3]
        elif QuerDAG.TYPE3_3_not.value == graph_type:

            if switch == False:
                raw = dataset.type3_3chain
            else:
                raw_data=list(extra_datasets[1][(('e', ('r', 'r','n')), ('e', ('r',)))])
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
            ...
            chains = [chain1,chain2,chain3]
            parts = [part1, part2, part3]
        elif QuerDAG.TYPE3_3_notdown.value == graph_type:

            if switch == False:
                raw = dataset.type3_3chain
            else:
                raw_data=list(extra_datasets[1][(('e', ('r', 'r')), ('e', ('r','n')))])
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
                    new_ex.data["raw_chain"]=[[ex[0][0],ex[0][1][0],-1],[-1,ex[0][1][1],targets],[ex[1][0],ex[1][1][0],targets]]
                    new_ex.data["anchors"]=[ex[0][0],ex[1][0]]
                    new_ex.data["type"]="3chain3_notdown"
                    new_ex.data["targets"]=targets
                    raw.append(new_ex)
            ...
            if switch == False:
                ...
                raw_data=list(extra_datasets[1][((('e', ('r',)), ('e', ('r',))), ('r',))])
                torch.save(raw_data,'/data/cqd2/type4_3ind.pt')
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
                    new_ex.data["raw_chain"]=[[ex[0][0][0],ex[0][0][1][0],-1],[ex[0][1][0],ex[0][1][1][0],-1],[-1,ex[1][0],targets]]
                    new_ex.data["anchors"]=[ex[0][0][0],ex[0][1][0]]
                    new_ex.data["type"]="4chain3"
                    new_ex.data["targets"]=targets
                    raw.append(new_ex)
            ...
            chains = [chain1,chain2,chain3]
            parts = [part1,part2,part3]
        elif QuerDAG.TYPE4_3_not.value == graph_type:
            if switch == False:
                raw = dataset.type4_3chain
            else:
                raw_data=list(extra_datasets[1][((('e', ('r',)), ('e', ('r','n'))), ('r',))])
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
            ...
            if switch == False:
                ...
                raw_data=list(extra_datasets[1][((('e', ('r',)), ('e', ('r',)), ('u',)), ('r',))])
                raw=[]
                for ex in raw_data:
                    new_ex=Chain()
                    targets=list(extra_datasets[0][ex])
